...
variable "SUBNET" {
  description = "(Required) The single subnet ID to use for deployment of the FSx for NetApp ONTAP source filer and KNFSD File Cache. Example: \"subnet-038e337f0ff4cd53f\". No default."
  type        = string
  nullable    = false
  validation {
