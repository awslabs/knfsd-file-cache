...
```bash
source = "github.com/awslabs/knfsd-file-cache/deployment/terraform-module-knfsd?ref=v1.1.0-alpha.16"
```
...
| `NUM_NFS_THREADS`       | The number of NFS threads to use for KNFSD.                                                                                                                                                                                                                                                                                                           | False    | `256`         |
