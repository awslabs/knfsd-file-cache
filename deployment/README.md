...
```bash
source = "github.com/awslabs/knfsd-file-cache/deployment/terraform-module-knfsd?ref=v1.1.0-alpha.17"
```
...
| `VPC_CIDR`                         | List of CIDR blocks to use in security group rules and `/etc/exports`. If empty, the primary VPC CIDR block is used. For secondary VPC CIDRs, you must explicitly provide the full list.                                                                                                                                                                                                                                                                       | False    | `[]`           |
