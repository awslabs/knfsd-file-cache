...
locals {
  descriptions = {
    ...
    READ_AHEAD                   = "(Optional) The NFS readahead value in bytes, applied via nfsrahead udev rule in \"/etc/nfs.conf.d/knfsd.conf\". Applies to all NFS mounts. Default: \"8388608\" (8 * 1024 * 1024 bytes = 8 MiB)."
