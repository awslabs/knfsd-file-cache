...
* `PRIVATE_HOSTED_ZONE` - (Optional) The R53 private hosted zone to use for DNS when "TRAFFIC_MODE = 'loadbalancer'". Defaults to: `knfsd.internal.` [Note: the trailing period is required].
