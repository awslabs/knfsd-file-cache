...
// use Makefile to generate test cert/key
...
func main() {
	...
	fmt.Fprintln(out, "/*")
	fmt.Fprintln(out, "\tCopyright 2022 Google LLC")
	fmt.Fprintln(out, "\tCopyright Amazon.com, Inc. or its affiliates. All Rights Reserved.")
