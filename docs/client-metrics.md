...
To build the metrics agent you will need [go 1.24](https://go.dev/) or later.
...
There are other methods to install Go. For simplicity, this example will install Go based on the [standard Go instructions](https://go.dev/doc/install).
  ...
  ```bash
  curl -fSLO https://go.dev/dl/go1.24.5.linux-amd64.tar.gz
...
You should see output similar to:
  ...
  ● knfsd-metrics-agent.service - Knfsd Metrics Agent
   ...
   Main PID: 606 (knfsd-metrics-a)
    ...
    2025-06-04T20:52:40.906+0100    info    service@v0.127.0/service.go:266 Starting knfsd-metrics-agent... {"resource": {}, "Version": "1.1.0-alpha.6", "NumCPU": 8}
